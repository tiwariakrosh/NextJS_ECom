            ...
            <section className="text-gray-600 body-font overflow-hidden">
                <div className="container px-5 py-24 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        {/* <img alt="ecommerce" className="lg:w-1/2  w-full lg:h-auto h-[60vh] object-cover object-top rounded" src="/image/m-jeans.jpg" /> */}
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div className="flex">
                                ...
                                <button onClick={() => { addToCart(slug, 2, 1240, 'Means Blue Jeans(XL, Blue)', 'XL', 'Red') }} className="flex ml-24 text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded">Add To Cart</button>
