    ...
    return (
        <div>
            <section className="text-gray-600 body-font">
                <h1 className='text-center font-bold text-3xl sm:mt-10 lg:mt-15 text-gray-800'>All Hoodies</h1>
                <div className="container px-20 py-24 mx-auto">
                    <div className="flex flex-wrap  -m-4">
                        {Object.keys(products).length === 0 && <div className='shadow-lg p-5 mx-auto'> <p>Sorry all of the Hoodies are currently out of stock.New stock comming soon!</p></div>}
                        {products ?
